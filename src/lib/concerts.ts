...
const VENUE_CITY: Record<string, string> = {
  ...
  'Kulturhuset Strömmen': 'Kalmar',
  'First Hotel Witt': 'Kalmar',
  'Scandic Winn': 'Karlstad',
  'Restaurang Ester': 'Kungsbacka',
  'Anders Bistro': 'Nordmaling',
  'Studion Umeå Folkets Hus': 'Umeå',
  'Kulturhuset Spira': 'Jönköping',
  'Dunkers kulturhus': 'Helsingborg',
  Bollbrolyckan: 'Helsingborg',
  Kulturbaren: 'Trollhättan',
  Hebeteatern: 'Trollhättan',
  Dynamo: 'Norrköping',
  'Odd Fellow': 'Stockholm',
  'Hjorthagens Kulturhus': 'Stockholm',
  'Spånga Folkan': 'Stockholm',
  'Varbergs Teater': 'Varberg',
  'Teater Halland': 'Varberg',
  'Västerports kök': 'Varberg',
  Kulturkällaren: 'Alvesta',
  'Bageriet Wermland opera': 'Karlstad',
  Basement: 'Karlshamn',
  'The POT/Navet på Piren': 'Karlshamn',
  'Biohuset Mariefred': 'Mariefred',
  'Hotel Öresund': 'Landskrona',
  Kikebokyrkan: 'Oskarshamn',
  'Kvarteret & Co': 'Örebro',
  'Palladium - Folkets Bio': 'Växjö',
  Risingegården: 'Åby',
  // L'Jazz i Ljungskile
